module uim.entities.projects.team_member;

@safe:
import uim.entities;

class DPRJProjectTeamMember : DOOPEntity {
  this() { super();
    this.attributes([
  ...
  override string entityClass() { return "prjProjectTeamMember"; }
  override string entityClasses() { return "prjProjectTeamMembers"; }
...
auto PRJProjectTeamMember() { return new DPRJProjectTeamMember; } 
auto PRJProjectTeamMember(Json json) { return new DPRJProjectTeamMember(json); } 

unittest {
  version(uim_entities) {
    assert(PRJProjectTeamMember);
  
  auto entity = PRJProjectTeamMember;
